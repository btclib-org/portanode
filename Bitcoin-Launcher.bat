...
if "%choice%"=="5" set "SCRIPT=%ROOTDIR%\win\scripts\bitcoin\regtest-18555-Bob-qt.bat"
if "%choice%"=="6" set "SCRIPT=%ROOTDIR%\win\scripts\bitcoin\regtest-18666-Carol-qt.bat"
