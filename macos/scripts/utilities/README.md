...
- `rotate-bitcoin-log.sh`: Rotates `bitcoin-datadir/debug.log` by truncateing the current log, creating its backup (debug.log.1, etc.) and starting a new log file.
